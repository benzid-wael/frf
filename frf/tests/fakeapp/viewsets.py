...
class CompanyViewSetV3(viewsets.ModelViewSet):
    obj_lookup_kwarg = 'id'
    model = models.Company
    serializer = serializers.CompanySerializerV3()


class CompanyViewSetV4(viewsets.ModelViewSet):
    obj_lookup_kwarg = 'id'
    model = models.Company
    serializer = serializers.CompanySerializerV4()
